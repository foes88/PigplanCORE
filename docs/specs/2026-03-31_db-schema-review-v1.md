# PigOS AI — DB Schema v1.0 검증 리포트
...
### 1.1 검증 목적
PigOS AI의 DB 스키마가 실제 양돈 생산 주기(번식 사이클)를 정확하게 표현할 수 있는지,
...
**현상**: 피그플랜의 TB_SAGO에 해당하는 테이블이 PigOS AI에 없음.
...
> 기준으로 PigOS AI DB Schema v1.0을 검증한 결과입니다.
